...
EBAY_APP_ID=your_ebay_app_id_optional_but_recommended
...
API mode with `EBAY_APP_ID` is recommended. Without it, ebayspy falls back to parsing public eBay
search pages, which can break if eBay changes markup or rate-limits the VPS.
